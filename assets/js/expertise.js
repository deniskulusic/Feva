...
let ScrollImgMultiple = document.querySelectorAll('#img1 , #img2 , #img4 , #img3 , #img5 , #img6');
...
let ScrollimgMultipleFromTop=[
    ...
    window.pageYOffset + ScrollImgMultiple[4].getBoundingClientRect().top,
    window.pageYOffset + ScrollImgMultiple[5].getBoundingClientRect().top
]
  function Repeat(){
